  ...
  if (normalizedOpts.nonInteractive && normalizedOpts.acceptRisk !== true) {
    runtime.error(
      [
        ...
        "Read: https://alpha-docs.vercel.app/security",
        `Re-run with: ${formatCliCommand("alpha onboard --non-interactive --accept-risk ...")}`,
      ].join("\n"),
    );
    runtime.exit(1);
    return;
  ...
  if (process.platform === "win32") {
    runtime.log(
      [
        ...
        "Guide: https://alpha-docs.vercel.app/windows",
      ].join("\n"),
    );
  }
